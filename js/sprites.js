...
const Sprites = {
  ...
  ANIM_DEFS: {
    hunter: {
      ...
      attack: { file: 'hero_hunter_attack', count: 4, frameH: 887, frameOffsets: [0, 417, 858, 1331], frameWidths: [417, 441, 473, 443], fps: [150, 140, 150, 150], groundOffset: 150, heightScale: 1.8 },
